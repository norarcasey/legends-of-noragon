...
[Open the SVG ↗](${OUT_DIR.replace('docs/', '')}/${dg.id}.svg)
...
Mermaid class diagrams (rendered inline on GitHub; SVGs linked under each). In the
diagrams:
...
[Open the SVG ↗](${OUT_DIR.replace('docs/', '')}/full.svg)
